...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _AuthInitial value)?  initial,TResult Function( _AuthLoading value)?  loading,TResult Function( _AuthAuthenticated value)?  authenticated,TResult Function( _AuthFailed value)?  failed,TResult Function( _AuthLogout value)?  logout,TResult Function( _AuthSignUp value)?  signUp,TResult Function( _AuthVerifyEmail value)?  verifyEmail,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return authenticated(_that);case _AuthFailed() when failed != null:
return failed(_that);case _AuthLogout() when logout != null:
return logout(_that);case _AuthSignUp() when signUp != null:
return signUp(_that);case _AuthVerifyEmail() when verifyEmail != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _AuthInitial value)  initial,required TResult Function( _AuthLoading value)  loading,required TResult Function( _AuthAuthenticated value)  authenticated,required TResult Function( _AuthFailed value)  failed,required TResult Function( _AuthLogout value)  logout,required TResult Function( _AuthSignUp value)  signUp,required TResult Function( _AuthVerifyEmail value)  verifyEmail,}){
final _that = this;
switch (_that) {
case _AuthInitial():
return initial(_that);case _AuthLoading():
return loading(_that);case _AuthAuthenticated():
return authenticated(_that);case _AuthFailed():
return failed(_that);case _AuthLogout():
return logout(_that);case _AuthSignUp():
return signUp(_that);case _AuthVerifyEmail():
return verifyEmail(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _AuthInitial value)?  initial,TResult? Function( _AuthLoading value)?  loading,TResult? Function( _AuthAuthenticated value)?  authenticated,TResult? Function( _AuthFailed value)?  failed,TResult? Function( _AuthLogout value)?  logout,TResult? Function( _AuthSignUp value)?  signUp,TResult? Function( _AuthVerifyEmail value)?  verifyEmail,}){
final _that = this;
switch (_that) {
case _AuthInitial() when initial != null:
return initial(_that);case _AuthLoading() when loading != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( LoginModel response,  String token)?  authenticated,TResult Function( String errorMessage)?  failed,TResult Function()?  logout,TResult Function( SignUpModel response)?  signUp,TResult Function( RequestEmailModel response)?  verifyEmail,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthInitial() when initial != null:
return initial();case _AuthLoading() when loading != null:
return loading();case _AuthAuthenticated() when authenticated != null:
return authenticated(_that.response,_that.token);case _AuthFailed() when failed != null:
return failed(_that.errorMessage);case _AuthLogout() when logout != null:
return logout();case _AuthSignUp() when signUp != null:
return signUp(_that.response);case _AuthVerifyEmail() when verifyEmail != null:
return verifyEmail(_that.response);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( LoginModel response,  String token)  authenticated,required TResult Function( String errorMessage)  failed,required TResult Function()  logout,required TResult Function( SignUpModel response)  signUp,required TResult Function( RequestEmailModel response)  verifyEmail,}) {final _that = this;
switch (_that) {
case _AuthInitial():
return initial();case _AuthLoading():
return loading();case _AuthAuthenticated():
return authenticated(_that.response,_that.token);case _AuthFailed():
return failed(_that.errorMessage);case _AuthLogout():
return logout();case _AuthSignUp():
return signUp(_that.response);case _AuthVerifyEmail():
return verifyEmail(_that.response);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( LoginModel response,  String token)?  authenticated,TResult? Function( String errorMessage)?  failed,TResult? Function()?  logout,TResult? Function( SignUpModel response)?  signUp,TResult? Function( RequestEmailModel response)?  verifyEmail,}) {final _that = this;
switch (_that) {
case _AuthInitial() when initial != null:
return initial();case _AuthLoading() when loading != null:
return loading();case _AuthAuthenticated() when authenticated != null:
...
class _AuthAuthenticated implements AuthState {
  const _AuthAuthenticated({this.response = const LoginModel(), this.token = ''});
  

@JsonKey() final  LoginModel response;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthAuthenticated&&(identical(other.response, response) || other.response == response)&&(identical(other.token, token) || other.token == token));
}
...
@useResult
$Res call({
 LoginModel response, String token
});
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? response = null,Object? token = null,}) {
  return _then(_AuthAuthenticated(
response: null == response ? _self.response : response // ignore: cast_nullable_to_non_nullable
as LoginModel,token: null == token ? _self.token : token // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthFailed&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@JsonKey() final  SignUpModel response;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthSignUp&&(identical(other.response, response) || other.response == response));
}
...
/// @nodoc
abstract mixin class _$AuthSignUpCopyWith<$Res> implements $AuthStateCopyWith<$Res> {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AuthVerifyEmailCopyWith<_AuthVerifyEmail> get copyWith => __$AuthVerifyEmailCopyWithImpl<_AuthVerifyEmail>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthVerifyEmail&&(identical(other.response, response) || other.response == response));
}
...
/// @nodoc
abstract mixin class _$AuthVerifyEmailCopyWith<$Res> implements $AuthStateCopyWith<$Res> {
  factory _$AuthVerifyEmailCopyWith(_AuthVerifyEmail value, $Res Function(_AuthVerifyEmail) _then) = __$AuthVerifyEmailCopyWithImpl;
@useResult
$Res call({
