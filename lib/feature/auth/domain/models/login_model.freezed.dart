...
mixin _$LoginModel {
 ...
 String? get kind; String? get localId; String? get email; String? get displayName; String? get idToken; bool? get registered; String? get refreshToken; String? get expiresIn;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,kind,localId,email,displayName,idToken,registered,refreshToken,expiresIn);
...
@useResult
$Res call({
 String? kind, String? localId, String? email, String? displayName, String? idToken, bool? registered, String? refreshToken, String? expiresIn
});
...
/// Create a copy of LoginModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? kind = freezed,Object? localId = freezed,Object? email = freezed,Object? displayName = freezed,Object? idToken = freezed,Object? registered = freezed,Object? refreshToken = freezed,Object? expiresIn = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? kind,  String? localId,  String? email,  String? displayName,  String? idToken,  bool? registered,  String? refreshToken,  String? expiresIn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginModel() when $default != null:
return $default(_that.kind,_that.localId,_that.email,_that.displayName,_that.idToken,_that.registered,_that.refreshToken,_that.expiresIn);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? kind,  String? localId,  String? email,  String? displayName,  String? idToken,  bool? registered,  String? refreshToken,  String? expiresIn)  $default,) {final _that = this;
switch (_that) {
case _LoginModel():
return $default(_that.kind,_that.localId,_that.email,_that.displayName,_that.idToken,_that.registered,_that.refreshToken,_that.expiresIn);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? kind,  String? localId,  String? email,  String? displayName,  String? idToken,  bool? registered,  String? refreshToken,  String? expiresIn)?  $default,) {final _that = this;
switch (_that) {
case _LoginModel() when $default != null:
return $default(_that.kind,_that.localId,_that.email,_that.displayName,_that.idToken,_that.registered,_that.refreshToken,_that.expiresIn);case _:
  return null;
...
class _LoginModel implements LoginModel {
  const _LoginModel({this.kind, this.localId, this.email, this.displayName, this.idToken, this.registered, this.refreshToken, this.expiresIn});
...
/// Create a copy of LoginModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? kind = freezed,Object? localId = freezed,Object? email = freezed,Object? displayName = freezed,Object? idToken = freezed,Object? registered = freezed,Object? refreshToken = freezed,Object? expiresIn = freezed,}) {
