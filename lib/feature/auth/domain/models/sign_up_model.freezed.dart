...
mixin _$SignUpModel {
 ...
 String? get kind; String? get idToken; String? get email; String? get refreshToken; String? get expiresIn; String? get localId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,kind,idToken,email,refreshToken,expiresIn,localId);
...
@useResult
$Res call({
 String? kind, String? idToken, String? email, String? refreshToken, String? expiresIn, String? localId
});
...
/// Create a copy of SignUpModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? kind = freezed,Object? idToken = freezed,Object? email = freezed,Object? refreshToken = freezed,Object? expiresIn = freezed,Object? localId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? kind,  String? idToken,  String? email,  String? refreshToken,  String? expiresIn,  String? localId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignUpModel() when $default != null:
return $default(_that.kind,_that.idToken,_that.email,_that.refreshToken,_that.expiresIn,_that.localId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? kind,  String? idToken,  String? email,  String? refreshToken,  String? expiresIn,  String? localId)  $default,) {final _that = this;
switch (_that) {
case _SignUpModel():
return $default(_that.kind,_that.idToken,_that.email,_that.refreshToken,_that.expiresIn,_that.localId);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? kind,  String? idToken,  String? email,  String? refreshToken,  String? expiresIn,  String? localId)?  $default,) {final _that = this;
switch (_that) {
case _SignUpModel() when $default != null:
return $default(_that.kind,_that.idToken,_that.email,_that.refreshToken,_that.expiresIn,_that.localId);case _:
  return null;
...
class _SignUpModel implements SignUpModel {
  const _SignUpModel({this.kind, this.idToken, this.email, this.refreshToken, this.expiresIn, this.localId});
...
/// Create a copy of SignUpModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? kind = freezed,Object? idToken = freezed,Object? email = freezed,Object? refreshToken = freezed,Object? expiresIn = freezed,Object? localId = freezed,}) {
