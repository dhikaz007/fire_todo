...
import '../../routes/services_module.dart';
import '../logging/app_logger.dart';
import '../storage/data/storage_token_repository_impl.dart';
...
class DioClient {
  ...
  Future<void> _handleAuthError(
    ...
    try {
      ...
      try {
        Modular.get<IAppNavigationRepository>().navigateToLoginAndClearStack();
      } catch (e) {
  ...
  Future<void> _setHeaders(RequestOptions options) async {
    ...
    final platform = await _initPlatformState();
  ...
  Future<String> _initPlatformState() async {
    try {
      return await DeviceUserAgent.instance.build();
