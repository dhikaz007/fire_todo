...
mixin _$ResponseAPI<T> {
  ...
  $ResponseAPICopyWith<T, ResponseAPI<T>> get copyWith =>
      _$ResponseAPICopyWithImpl<T, ResponseAPI<T>>(
          this as ResponseAPI<T>, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ResponseAPI<T> &&
...
abstract mixin class $ResponseAPICopyWith<T, $Res> {
  factory $ResponseAPICopyWith(
          ResponseAPI<T> value, $Res Function(ResponseAPI<T>) _then) =
      _$ResponseAPICopyWithImpl;
  @useResult
  $Res call({T? data});
}
...
extension ResponseAPIPatterns<T> on ResponseAPI<T> {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ResponseAPI<T> value)? $default, {
...
class _ResponseAPI<T> implements ResponseAPI<T> {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ResponseAPICopyWith<T, _ResponseAPI<T>> get copyWith =>
      __$ResponseAPICopyWithImpl<T, _ResponseAPI<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ResponseAPI<T> &&
            const DeepCollectionEquality().equals(other.data, data));
  }
...
/// @nodoc
abstract mixin class _$ResponseAPICopyWith<T, $Res>
    implements $ResponseAPICopyWith<T, $Res> {
  factory _$ResponseAPICopyWith(
          _ResponseAPI<T> value, $Res Function(_ResponseAPI<T>) _then) =
      __$ResponseAPICopyWithImpl;
  @override
  @useResult
  $Res call({T? data});
}
